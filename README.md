...
1. Load a page with a grid of items, where the last row of items is partially visible at the bottom of the viewport.
   reducing grid columns..., increasing itemsperpage.
